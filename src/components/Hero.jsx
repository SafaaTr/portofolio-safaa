    ...
    <div className=' pt-100 '>
          <div className="md:flex justify-between items-center bg-[url(/images/Lines.svg)] bg-cover bg-center   ">
            ...
            <div className='z-10  mx-20 md:mx-70 sm:mx-20 pb-20 relative'>
                ...
                <button className='w-155  h-50 bg-white rounded-md font-medium opacity-78  text-white dark:text-black' > <a href="/File/Safaa-Mahmoud_-Altarshan_FlowCV_Resume_2026-04-22.pdf"> {contentHero.contentButton}</a> </button>
            </div>
