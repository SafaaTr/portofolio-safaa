...
function MenuNav({active,setActive}) {
  ...
  return (
    <div className='flex md:hidden'>
        ...
        <div className={`fixed z-20 top-0 right-0 h-full w-250 bg-[#111827] dark:bg-white dark:text-black    transform transition-transform duration-300 ${ menu? "translate-x-0" :"translate-x-full"} `}>
